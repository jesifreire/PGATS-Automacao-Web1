...
describe('Automation Exercise', () => {
  ...
  it('Cadastrar um usuário', () => {
    ...
    cy.xpath('//*[@data-qa="signup-name"]').type('Qa Eevee')
  ...
  it('Login de usuário com e-mail e senha corretos', () => {
    ...
    cy.xpath('//*[@data-qa="login-email"]').type('eevee-1759530412987@teste.com')
    cy.xpath('//*[@data-qa="login-password"]').type('123456', { log: false })
    cy.xpath('//*[@data-qa="login-button"]').click()
    cy.xpath('//b[contains(text(), "Qa Eevee")]').should('be.visible')
  })
  ...
  it('Cadastrar usuário com e-mail e senha existente', () => {
    ...
    cy.xpath('//*[@data-qa="signup-name"]').type('Qa Eevee')
    cy.xpath('//*[@data-qa="signup-email"]').type('eevee-1759530412987@teste.com')
    cy.xpath('//button[contains(text(), "Signup")]').click()
  ...
  it('Enviar um formulário de contato', () => {
    ...
    cy.xpath('//*[@data-qa="email"]').type('eevee-1759530412987@teste.com')
